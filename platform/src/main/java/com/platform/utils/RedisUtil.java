...
public class RedisUtil {
    ...
    /**
     * 设置 String 类型 key-value 并添加过期时间 (以秒为单位)
     *
     * @param key
     * @param value
     ...
     * @return
     */
    public Long increment(String key, String field, long number) {
     ...
     * @return
     */
    public Double increment(String key, String field, Double number) {
        return redisTemplate.opsForHash().increment(key, field, number);
    }

    /**
     * 获取指定 key 和 filed下的 value
     *
     * @param key
     * @param field
     * @return
    ...
    /**
     * 验证指定 key 下 有没有指定的 field
     *
     * @param key
     * @param field
     * @return
     */
    public boolean field(String key, String field) {
        return redisTemplate.opsForHash().hasKey(key, field);
    }

    /**
     * 获取 key 下的 所有 field 字段名
     *
     * @param key
     * @return
     */
    ...
    /**
     * 获取列表 指定范围内的所有值    若参数为0 ,-1 则是查询List中所有元素
     *
     * @param key
     * @param start
     * @param end
